...
import { ext, isEmbyProvider, isSubtitleFile, pathDir, pathJoin } from "~/utils"
...
const Preview = () => {
  ...
  let embyPlayback: ReturnType<typeof createEmbyPlayback>
  let option: Option = {
  ...
  onMount(() => {
    ...
    embyPlayback = createEmbyPlayback({
      player,
      getPath: pathname,
      getName: () => objStore.obj.name,
    ...
    player.on("error", () => {
      ...
      embyPlayback.onError()
    })
  })
  onCleanup(() => {
    embyPlayback?.destroy()
